            ...
            <form onSubmit={handleSubmit} className='w-full h-full flex flex-col items-center justify-center gap-4'>
              <div className='w-[280px] flex flex-col gap-4'>
                <div className='w-full flex flex-col gap-1'>
                  ...
                  <input className='w-full h-[36px] p-2 border-[1px] border-[solid] border-[#999] rounded-md focus:border-[#0B175B] outline-none' placeholder='Ism Familiya' value={name} onChange={(e) => setName(e.target.value)} type="text" id='name' required />
                </div>
                <div className='flex flex-col gap-1'>
                  <label className='text-lg' htmlFor="phone">Telefon</label>
                  <input className='w-full h-[36px] p-2 border-[1px] border-[solid] border-[#999] rounded-md focus:border-[#0B175B] outline-none' placeholder='Telefon raqam' value={phone} onChange={(e) => setPhone(e.target.value)} type="tel" id='phone' required />
                </div>
